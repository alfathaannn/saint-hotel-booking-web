...
import { IoTimeOutline, IoHomeOutline, IoReceiptOutline } from "react-icons/io5";
import { Metadata } from "next";

export const metadata: Metadata = {
    title: "Payment Pending | Booking Pending",
    description: "Your payment has been pending and your booking is pending",
};

const PaymentPending = async () => {
    return (
        <div className="min-h-screen bg-yellow-50 flex items-center justify-center px-4 py-14">
            <div className="max-w-lg">
                {/* Success Card */}
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    {/* Header Section */}
                    <div className="px-8 pt-8 pb-6 text-center border-b border-gray-100">
                        <div className="inline-flex items-center justify-center bg-yellow-50 rounded-full mb-4">
                            <IoTimeOutline className="w-12 h-12 text-yellow-600" />
                        </div>
                        <h1 className="text-2xl font-bold text-gray-900 mb-2">
                            Booking Pending!
                        </h1>
                        <p className="text-gray-500 text-sm">
                            Your reservation has been pending
                        </p>
                    </div>
                    ...
                    <div className="px-8 py-6">
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-xs">
                                <span className="px-3 bg-yellow-50 text-gray-400">Next Steps</span>
                            </div>
                        </div>
