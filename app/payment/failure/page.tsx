...
export const metadata: Metadata = {
    title: "Payment Failure | Booking Failed",
    description: "Your payment has been failed and your booking is failed",
};

const PaymentFailure = async () => {
    return (
        <div className="min-h-screen bg-red-50 flex items-center justify-center px-4 py-14">
            <div className="max-w-lg">
                {/* Success Card */}
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    {/* Header Section */}
                    <div className="px-8 pt-8 pb-6 text-center border-b border-gray-100">
                        <div className="inline-flex items-center justify-center bg-red-50 rounded-full mb-4">
